...
pub fn run() {
    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            tauri::async_runtime::spawn(async move {
                ...
                tauri::async_runtime::spawn(async move {
                    ...
                    run_step(
                        "PiAgent usage initial sync",
                        crate::services::session_usage_pi_agent::sync_pi_agent_usage(db),
                    );
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_pi_agent_live_provider_ids,
            commands::get_pi_agent_live_provider,
            commands::set_pi_agent_live_provider,
            commands::remove_pi_agent_live_provider,
            commands::get_pi_agent_config,
