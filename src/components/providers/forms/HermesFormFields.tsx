...
export type HermesApiMode = string;
...
export const hermesApiModes: Array<{ value: string; labelKey: string }> = [
  { value: "openai", labelKey: "hermes.form.apiModeOpenAI" },
  { value: "anthropic", labelKey: "hermes.form.apiModeAnthropic" },
];
