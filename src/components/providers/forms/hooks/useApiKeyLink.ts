...
type ProviderPreset = Record<string, any>;
type CodexProviderPreset = Record<string, any>;
type GeminiProviderPreset = Record<string, any>;
type OpenCodeProviderPreset = Record<string, any>;
