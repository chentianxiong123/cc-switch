...
const OPENCODE_PRESET_MODEL_VARIANTS: Record<string, Array<{ id: string; variants?: Record<string, unknown>; options?: Record<string, unknown>; contextLimit?: number; outputLimit?: number }>> = {};
